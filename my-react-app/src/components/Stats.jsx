    ...
    return (
        <div className={styles.layout}>
            <div className={styles.layout} style={{gap: '0.5rem', transform: 'translateY(0rem)'}}>
                <img src="/src/assets/Images/heart-icon.png" alt="Coin Icon" style={{width: '40px', height: '40px'}} />
                <p id={`GOLD`}>100</p>
            </div>
            <div className={styles.layout} style={{gap: '0.5rem', transform: 'translateY(0rem)'}}>
                <img src="/src/assets/Images/parchment-icon.png" alt="Coin Icon" style={{width: '40px', height: '40px'}} />
                <p id={`PEOPLE`}>100</p>
            </div>
